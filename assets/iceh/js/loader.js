(async function() {
    ...
    if (('undefined' != typeof EJS_DEBUG_XX && true === EJS_DEBUG_XX) ||
        ...
        await loadStyle('https://imadejptr.glitch.me/assets/emu/data/emu-css.css');
        await loadScript('https://imadejptr.glitch.me/assets/emu/data/emu-main.js');
        await loadScript('https://imadejptr.glitch.me/assets/emu/data/emulator.js');
    } else {
        await loadStyle('https://imadejptr.glitch.me/assets/emu/data/emu-css.min.css');
        await loadScript('https://imadejptr.glitch.me/assets/emu/data/emulator.min.js');
    }
    let config = {};
